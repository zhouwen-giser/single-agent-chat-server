...
| AC-003     | P01   | ADR 0003; conversation/context/directory/result contracts | `tests/v03-contracts.contract.test.ts`; architecture gate | In verification                   |
| AC-004–006 | P02   | configured model adapter/readiness                        | P02 unit/contract/security                                | Planned                           |
| AC-007–009 | P03   | conversation message/summary migration and repository     | P03 PostgreSQL/restart                                    | Planned                           |
...
| AC-017–021 | P06   | strict TurnDecision and deterministic resolver            | P01 schema plus P06 resolver tests                        | Contract frozen; behavior planned |
